...
async def test_create_user_with_valid_data(db_session, email_service, mock_smtp):
    user_data = {
...
async def test_create_user_with_invalid_data(db_session, email_service, mock_smtp):
    user_data = {
...
async def test_register_user_with_valid_data(db_session, email_service, mock_smtp):
    user_data = {
...
async def test_register_user_with_invalid_data(db_session, email_service, mock_smtp):
    user_data = {
